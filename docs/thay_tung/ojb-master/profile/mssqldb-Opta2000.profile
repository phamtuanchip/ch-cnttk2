...
jdbcLevel = 2.0
urlProtocol = jdbc
urlSubprotocol = inetdae7a
torque.database.user = sa
torque.database.password =
urlDbalias = ?database=OJB&amp;sql7=true&amp;useCursorsAlways=false&amp;username=${torque.database.user};password=${torque.database.password};

#jdbc:inetdae7a:localhost:1433?database=OJB&amp;sql7=true&amp;useCursorsAlways=false
...
torque.database.driver = com.inet.tds.TdsDriver
