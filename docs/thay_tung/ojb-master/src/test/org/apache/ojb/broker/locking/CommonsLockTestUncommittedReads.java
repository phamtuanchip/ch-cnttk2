...
public class CommonsLockTestUncommittedReads extends OJBTestCase
{
    ...
    {
        String[] arr = {CommonsLockTestUncommittedReads.class.getName()};
        junit.textui.TestRunner.main(arr);
    }

    public CommonsLockTestUncommittedReads(String name)
    {
        super(name);
    }
    ...
    Object tx1;
    Object tx2;
    org.apache.ojb.broker.Article obj;
    ...
    {
        assertTrue(lockManager.writeLock(tx1, obj, testIsoLevel));
        assertFalse(lockManager.writeLock(tx2, obj, testIsoLevel));
    }
