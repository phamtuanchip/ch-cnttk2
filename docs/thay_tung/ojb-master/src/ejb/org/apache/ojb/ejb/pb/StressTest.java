 ...
 * @version $Id: StressTest.java,v 1.1 2007-08-24 22:17:37 ewestfal Exp $
 */
public class StressTest
{
     ...
     * PB-api test class
     */
    static class PBTestClient extends TestClient
    {
        ...
        public PBTestClient(StressTest arg)
        {
            test = arg;
            init();
            articlesList = new ArrayList();
            articleName = "PBTestClient_" + System.currentTimeMillis();
