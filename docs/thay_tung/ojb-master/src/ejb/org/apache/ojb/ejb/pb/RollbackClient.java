...
/**
 * Test client using the {@link org.apache.ojb.ejb.odmg.RollbackBean}.
 *
 * @author <a href="mailto:arminw@apache.de">Armin Waibel</a>
 * @version $Id: RollbackClient.java,v 1.1 2007-08-24 22:17:37 ewestfal Exp $
 */
public class RollbackClient extends TestCase
{
    ...
    */
    ...
    public void testRollbackSetRollbackAndThrowException() throws Exception
    {
        System.out.println("## testRollbackSetRollbackAndThrowException");
        int personsBefore = rollbackBean.getPersonCount();
