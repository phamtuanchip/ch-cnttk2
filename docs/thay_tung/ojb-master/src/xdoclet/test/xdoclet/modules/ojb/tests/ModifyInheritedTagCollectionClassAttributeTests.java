 ...
 */
public class ModifyInheritedTagCollectionClassAttributeTests extends OjbTestBase
{
    public ModifyInheritedTagCollectionClassAttributeTests(String name)
    {
        super(name);
    }

    // Test: removing collection-class of remotely inherited collection
    ...
    // Test: removing collection-class of inherited collection where collection type is not handable by OJB
    ...
    // Test: setting collection-class of inherited collection
    ...
    // Test: setting collection-class of inherited collection to user-defined type
    ...
    // Test: setting collection-class of inherited collection to non-collection type
    public void testCollectionClass5()
    {
        ...
        addClass(
            ...
            "/** @ojb.class\n"+
            "  * @ojb.modify-inherited name=\"attr\"\n"+
            "  *                       collection-class=\"java.lang.String\"\n"+
            "  */\n" +
            "public class B extends A {}");
        addClass(
            "test.C",
    ...
    // Test: setting collection-class of inherited array to non-array type
    ...
    // Test: changing collection-class of inherited collection to user-defined type
    ...
    // Test: changing collection-class of inherited collection to collection type unrelated to the variable type 
    ...
    // Test: setting collection-class of inherited array to a type that is not a collection but strict is set to false
