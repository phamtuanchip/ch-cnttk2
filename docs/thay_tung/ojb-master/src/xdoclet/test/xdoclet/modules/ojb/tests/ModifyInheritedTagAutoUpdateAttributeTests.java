...
/**
 * Tests for the ojb.modify-inherited tag with the auto-update attribute.
 *
 * @author <a href="mailto:tomdz@users.sourceforge.net">Thomas Dudziak (tomdz@users.sourceforge.net)</a>
 */
public class ModifyInheritedTagAutoUpdateAttributeTests extends OjbTestBase
{
    public ModifyInheritedTagAutoUpdateAttributeTests(String name)
    {
        super(name);
    }

    // Test: modifying the auto-update attribute of a field in a direct base class
    ...
    // Test: modifying the auto-update attribute of a reference
    ...
    // Test: modifying the auto-update attribute of a collection
    ...
    // Test: modifying the auto-update attribute of an anonymous field in a direct base class
