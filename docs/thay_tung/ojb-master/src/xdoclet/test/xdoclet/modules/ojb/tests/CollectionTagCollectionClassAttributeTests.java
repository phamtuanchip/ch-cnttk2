 ...
 */
public class CollectionTagCollectionClassAttributeTests extends OjbTestBase
{
    public CollectionTagCollectionClassAttributeTests(String name)
    {
        super(name);
    }

    // Test: empty value and variable type is handable by ojb
    ...
    // Test: empty value and variable type is defined by ojb
    public void testCollectionClass2()
    {
        addClass(
            ...
            "    *                 collection-class=\"\"\n"+
            "    */\n"+
            "  private org.apache.ojb.odmg.collections.DListImpl attr;\n"+
            "}");
        addClass(
            "test.B",
            "package test;\n"+
    ...
    // Test: empty value and variable type is array of persistent class
    ...
    // Test: empty value and variable type is user-defined collection
    public void testCollectionClass4()
    {
        addClass(
            ...
            "    *                 collection-class=\"\"\n"+
            "    */\n"+
            "  private "+TestCollectionClass.class.getName()+" attr;\n"+
            "}");
        addClass(
            "test.B",
            "package test;\n"+
    ...
    // Test: collection-class set to DListImpl (an ojb class and sub-type of List)
    ...
    // Test: collection-class set to ManagableArrayList (an ojb class) but variable is array
    ...
    // Test: collection-class set to ManagableVector (an ojb class) but variable is HashMap
    ...
    // Test: collection-class set to user-defined collection class related to the variable type
    ...
    // Test: collection-class set to user-defined collection class unrelated to the variable type
    ...
    // Test: collection-class set to a class not implementing ManageableCollection
    ...
    // Test: collection-class set to ManagableHashMap (an ojb class and sub-type of HashMap)
    ...
    // Test: inherited collection-class set to user-defined collection class related to the variable type
    public void testCollectionClass14()
    {
        addClass(
            ...
            "    *                 database-foreignkey=\"false\"\n"+
            "    */\n"+
            "  private java.util.Collection attr;\n"+
            "}");
        addClass(
            "test.B",
            "package test;\n"+
    ...
    // Test: same as test 7 (collection-class set to ManagableVector but variable is HashMap) but strict is set to false
