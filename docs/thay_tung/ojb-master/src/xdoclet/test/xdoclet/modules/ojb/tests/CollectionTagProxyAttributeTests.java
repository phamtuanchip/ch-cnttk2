...
/**
 * Tests for the ojb.collection tag with the proxy and proxy-prefetching-limit attributes.
 *
 * @author <a href="mailto:tomdz@users.sourceforge.net">Thomas Dudziak (tomdz@users.sourceforge.net)</a>
 */
public class CollectionTagProxyAttributeTests extends OjbTestBase
{
    public CollectionTagProxyAttributeTests(String name)
    {
        super(name);
    }
    ...
    // Test: proxy-prefetching-limit with zero value
    ...
    // Test: proxy-prefetching-limit with some value
    ...
    // Test: proxy-prefetching-limit with non-numeric value
    ...
    // Test: proxy-prefetching-limit with illegal value
    ...
    // Test: proxy-prefetching-limit with value value when no proxying is used
