...
/**
 * Tests for the ojb.collection tag with the documentation attribute
 *
 * @author <a href="mailto:tomdz@users.sourceforge.net">Thomas Dudziak (tomdz@users.sourceforge.net)</a>
 */
public class CollectionTagDocumentationAttributeTests extends OjbTestBase
{
    public CollectionTagDocumentationAttributeTests(String name)
    {
        super(name);
    }
