...
/**
 * Tests for the ojb.modify-inherited tag with the auto-retrieve attribute.
 *
 * @author <a href="mailto:tomdz@users.sourceforge.net">Thomas Dudziak (tomdz@users.sourceforge.net)</a>
 */
public class ModifyInheritedTagAutoRetrieveAttributeTests extends OjbTestBase
{
    public ModifyInheritedTagAutoRetrieveAttributeTests(String name)
    {
        super(name);
    }

    // Test: modifying the auto-retrieve attribute of a field in a direct base class
    ...
    // Test: modifying the auto-retrieve attribute of a reference
    ...
    // Test: modifying the auto-retrieve attribute of a collection
    ...
    // Test: modifying the auto-retrieve attribute of an anonymous field in a direct base class
