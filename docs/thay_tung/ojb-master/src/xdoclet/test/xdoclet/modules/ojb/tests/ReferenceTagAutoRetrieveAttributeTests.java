...
/**
 * Tests for the ojb.reference tag with the auto-retrieve attribute
 *
 * @author <a href="mailto:tomdz@users.sourceforge.net">Thomas Dudziak (tomdz@users.sourceforge.net)</a>
 */
public class ReferenceTagAutoRetrieveAttributeTests extends OjbTestBase
{
    public ReferenceTagAutoRetrieveAttributeTests(String name)
    {
        super(name);
    }
