 ...
 */
public class CollectionTagElementClassRefAttributeTests extends OjbTestBase
{
    public CollectionTagElementClassRefAttributeTests(String name)
    {
        super(name);
    }

    // Test: empty value, variable type is array of persistent type
    ...
    // Test: empty value, variable type is array of non-persistent type with a persistent sub-type
    ...
    // Test: empty value, variable type is array of not-persistent type
    ...
    // Test: empty value, variable type is array of primitives
    ...
    // Test: empty value, variable type is collection class
    ...
    // Test: value points to a primitive type
    public void testElementClassRef6()
    {
        addClass(
            ...
            "  /** @ojb.field primarykey=\"true\" */\n"+
            "  private int id;\n"+
            "  /** @ojb.collection element-class-ref=\"int\"\n"+
            "    *                 foreignkey=\"aid\"\n"+
            "    */\n"+
            "  private java.util.List attr;\n"+
            "}");
    ...
    // Test: value points to a persistent class
    ...
    // Test: value points to a non-persistent class
    ...
    // Test: value points to a non-persistent class with a persistent sub-type
    ...
    // Test: value points to a persistent class, variable type is array of same class
    ...
    // Test: value points to a persistent class, variable type is array of not-persistent base class
    ...
    // Test: value points to a persistent class, variable type is array of unrelated class
    ...
    // Test: inherited, value points to a persistent class
    ...
    // Test: value points to a persistent class which is not related to the array type but strict is set to false
    ...
    // Test: value points to a persistent nested class where the reference uses "$"
