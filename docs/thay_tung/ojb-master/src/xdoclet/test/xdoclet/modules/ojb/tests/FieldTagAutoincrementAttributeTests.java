 ...
 */
public class FieldTagAutoincrementAttributeTests extends OjbTestBase
{
    public FieldTagAutoincrementAttributeTests(String name)
    {
        super(name);
    }

    // Test: autoincrement attribute with no value
    ...
    // Test: autoincrement attribute with invalid value
    ...
    // Test: autoincrement attribute with 'none' value
    ...
    // Test: autoincrement attribute with 'ojb' value
    ...
    // Test: autoincrement attribute with 'database' value
    ...
    // Test: inherited autoincrement attribute with 'ojb' value
