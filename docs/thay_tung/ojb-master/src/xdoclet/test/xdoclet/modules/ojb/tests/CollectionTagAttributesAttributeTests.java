...
/**
 * Tests for the ojb.collection tag with the attributes attribute
 *
 * @author <a href="mailto:tomdz@users.sourceforge.net">Thomas Dudziak (tomdz@users.sourceforge.net)</a>
 */
public class CollectionTagAttributesAttributeTests extends OjbTestBase
{
    public CollectionTagAttributesAttributeTests(String name)
    {
        super(name);
    }
    ...
    // Test: attributes attribute with one pair
    ...
    // Test: attributes attribute with three pairs
