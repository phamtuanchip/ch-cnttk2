...
/**
 * Tests for the ojb.collection tag with the refresh attribute
 *
 * @author <a href="mailto:tomdz@users.sourceforge.net">Thomas Dudziak (tomdz@users.sourceforge.net)</a>
 */
public class CollectionTagRefreshAttributeTests extends OjbTestBase
{
    public CollectionTagRefreshAttributeTests(String name)
    {
        super(name);
    }

    // Test: refresh attribute has empty value
    ...
    // Test: refresh attribute has invalid value
    ...
    // Test: refresh attribute has 'true' value
    ...
    // Test: refresh attribute has 'false' value
    ...
    // Test: inherited refresh attribute
