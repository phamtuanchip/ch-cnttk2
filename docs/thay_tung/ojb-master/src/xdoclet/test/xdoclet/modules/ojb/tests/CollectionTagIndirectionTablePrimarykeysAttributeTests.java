...
/**
 * Tests for the ojb.collection tag with the indirection-table attribute together with its indirection-table-primarykeys attribute.
 *
 * @author <a href="mailto:tomdz@apache.org">Thomas Dudziak</a>
 */
public class CollectionTagIndirectionTablePrimarykeysAttributeTests extends OjbTestBase
{
    public CollectionTagIndirectionTablePrimarykeysAttributeTests(String name)
    {
        super(name);
    }

    // Test: indirection-table with two classes; foreignkeys are also primarykey
    public void testIndirectionTable1()
    {
        addClass(
            ...
            "    *                 indirection-table-primarykeys=\"true\"\n"+
            "    */\n"+
            "  private B[] bs;\n"+
            "}");
        addClass(
    ...
    // Test: indirection-table with two classes; primarykeys attribute is set to true and false
    public void testIndirectionTable2()
    {
        ...
        addClass(
            ...
            "    *                 foreignkey=\"BID\"\n"+
            "    *                 indirection-table=\"A_B\"\n"+
            "    *                 indirection-table-primarykeys=\"false\"\n"+
            "    */\n"+
    ...
    // Test: indirection-table with two classes; primarykeys is set to false
    ...
    // Test: indirection-table with two classes; primarykeys is set to true with multiple fields that make up the foreignkeys
    ...
    // Test: indirection-table-primarykeys with no value
    ...
    // Test: indirection-table-primarykeys with illegal value
    public void testIndirectionTable6()
    {
        addClass(
            ...
            "  /** @ojb.collection foreignkey=\"AID\"\n"+
            "    *                 indirection-table=\"A_B\"\n"+
            "    *                 indirection-table-primarykeys=\"yes\"\n"+
            "    */\n"+
            "  private B[] bs;\n"+
            "}");
        addClass(
