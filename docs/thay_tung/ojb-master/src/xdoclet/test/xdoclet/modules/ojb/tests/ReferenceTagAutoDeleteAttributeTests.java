...
/**
 * Tests for the ojb.reference tag with the auto-delete attribute
 *
 * @author <a href="mailto:tomdz@users.sourceforge.net">Thomas Dudziak (tomdz@users.sourceforge.net)</a>
 */
public class ReferenceTagAutoDeleteAttributeTests extends OjbTestBase
{
    public ReferenceTagAutoDeleteAttributeTests(String name)
    {
        super(name);
    }
