 ...
 * @version $Id: DatabaseMetaDataTreeModel.java,v 1.1 2007-08-24 22:17:41 ewestfal Exp $
 */
    ...
    implements java.io.Serializable
{
    ...
    {
        super(new javax.swing.tree.DefaultMutableTreeNode("initializing"));
        this.dbMetadata = pdbMetadata;
        DBMetaRootNode rootNode = new DBMetaRootNode(dbMetadata, this);
        super.setRoot(rootNode);        
        rootNode.loadWait(true, false, true);
    }
