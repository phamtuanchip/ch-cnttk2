...
/**
 * This is an implementation of a PropertyEditor for the DBMetaTableNode.
 *
 * @author <a href="mailto:bfl@florianbruckner.com">Florian Bruckner</a> 
 * @version $Id: JPnlPropertyEditorDBMetaTable.java,v 1.1 2007-08-24 22:17:29 ewestfal Exp $
 */
public class JPnlPropertyEditorDBMetaTable extends PropertyEditor
{
    ...
    private void initComponents()//GEN-BEGIN:initComponents
    {
        ...
        add(tfTableName, gridBagConstraints);
    ...
    public class CatalogPropertyChangeListener implements java.beans.PropertyChangeListener
    {
        public void propertyChange (java.beans.PropertyChangeEvent propertyChangeEvent)
        {
            ...
            {
                tfTableName.setText((String)propertyChangeEvent.getNewValue());
            }
        }        
    }
